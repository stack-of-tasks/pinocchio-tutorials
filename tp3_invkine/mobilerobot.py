...
class MobileRobotWrapper(RobotWrapper):
    ...
    def __init__(self,urdf,pkgs):
        RobotWrapper.__init__(self,urdf,pkgs,se3.JointModelPlanar())
    ...
    def display(self,q):
        ...
        self.viewer.gui.applyConfiguration('world/framebasis',M2gv(self.data.oMf[-2]))
        self.viewer.gui.applyConfiguration('world/frametool', M2gv(self.data.oMf[-1]))
